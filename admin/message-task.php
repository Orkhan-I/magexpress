                ...
                <div class="row">
                   <div class="col-md-6">
                    ...
                    <?php
                           ...
                           ?>
                           <div class="<?php if($i%2==0){ echo 'chat-widget-left'; }else if($i%2>=0){ echo 'chat-widget-right';}
                                    ?>">
                                   
                                        <?php echo $rows[$i]['message'];?>
                                    </div>
                                    <div class="<?php if($i%2==0){ echo 'chat-widget-name-left';  }else if($i%2>=0) { echo 'chat-widget-name-right';}?>">

                                  
                                        <h4> <?php echo $rows[$i]['name'];?></h4>
                                    </div>
                        <?php
                            }  ?>
